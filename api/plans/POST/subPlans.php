    ...
    <tr>
      <td class="body-block" style="background:#ffffff;padding:48px 48px 44px;">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="100%" style="margin-bottom:28px;"><tr><td align="center" style="border-radius:12px;overflow:hidden;line-height:0;">
          <img src="https://images.unsplash.com/photo-1622021142947-da7dedc7c39a?q=80&w=1032&auto=format&fit=crop" alt="Restaurant image" width="504" style="display:block;width:100%;max-width:504px;height:200px;object-fit:cover;border-radius:12px;filter:brightness(0.88) saturate(0.85);" />
        </td></tr></table>
